...
/*
 * Rediseño Figma 5001:273 (mapa único, sin tabs) + 5001:282 (cards desktop) +
 * 5001:278/279 (mobile). Un solo plano de la casa (735×534) con 4 puntos:
 * cerco (activo al entrar), monitoreo, cctv y gps.
 */
const STORAGE_KEY = 'sise-tech-editor-v3';
const AREA_ID = 'mapa';

const DEFAULT_POSITIONS = {
  [AREA_ID]: {
    cerco: { top: 201, left: 47 },
    monitoreo: { top: 265, left: 455 },
    cctv: { top: 254, left: 0 },
    gps: { top: 339, left: 591 }
  }
};

const HOUSE_BASE_SIZES = {
  [AREA_ID]: { width: 735, height: 534 }
};
...
const POINTS = [
  ...
  { id: 'gps', label: 'GPS y Dashcams', pointClassName: styles.ellipse14 }
];
...
const SLIDES = [
  {
    ...
    text: 'Tu primera línea de defensa. Barrera física de alta tensión conectada directamente a nuestra central.',
    /* Desktop (Figma 3502:561): corta después de "defensa."; mobile envuelve solo. */
    desktopTextLines: [
      'Tu primera línea de defensa.',
      'Barrera física de alta tensión conectada directamente a nuestra central.'
    ],
    mobileTall: true,
    mobileViewport: 'tall',
    styleVars: {
      ...
      '--tech-card-mobile-art-height': '83px'
    },
    mobileShell: { width: '201px', height: '300px', top: '0px', left: '0px', background: '#D9D9D9', borderRadius: '22px' },
    art: { type: 'image', src: '/image/tech-hogar-cerco.webp', width: 215, height: 107 }
  },
  {
    id: 'monitoreo',
    title: 'Monitoreo de Alarmas',
    titleLines: ['Monitoreo', 'de Alarmas'],
    text: 'Respuesta inmediata 24/7 ante intrusiones. Profesionales cuidando tu hogar, no solo una sirena.',
    mobileTall: true,
    mobileViewport: 'tall',
    styleVars: {
      ...
      '--tech-card-mobile-title-width': '188px',
      '--tech-card-mobile-text-top': '77px',
      '--tech-card-mobile-text-width': '150px',
      '--tech-card-mobile-art-top': '193px',
      '--tech-card-mobile-art-width': '116px',
      '--tech-card-mobile-art-height': '89px'
    },
    mobileShell: { width: '201px', height: '300px', top: '0px', left: '0px', background: '#D9D9D9', borderRadius: '22px' },
    art: { type: 'image', src: '/image/tech-hogar-monitoreo.webp', width: 175, height: 128 }
  },
  {
    id: 'cctv',
    title: 'CCTV / Videovigilancia',
    /* Mobile (Figma 3214:749): la card conserva el título "Cámaras de vigilancia". */
    mobileTitleLines: ['Cámaras', 'de vigilancia'],
    text: 'Control en tiempo real desde tu celular. Mirá tu casa en alta definición estés donde estés.',
    mobileTall: true,
    mobileViewport: 'tall',
    styleVars: {
      ...
      '--tech-card-mobile-text-width': '154px',
      '--tech-card-mobile-art-top': '194px',
      '--tech-card-mobile-art-width': '129px',
      '--tech-card-mobile-art-height': '73px'
    },
    mobileShell: { width: '201px', height: '300px', top: '0px', left: '0px', background: '#D9D9D9', borderRadius: '22px' },
    art: { type: 'image', src: '/image/tech-hogar-cctv.webp', width: 192, height: 117 }
  },
  {
    id: 'gps',
    title: 'GPS y Dashcams',
    titleLines: ['GPS y', 'Dashcams'],
    text: 'Seguridad en movimiento. Ubicación satelital y grabación en video para cuidar tu vehículo.',
    mobileTall: true,
    mobileViewport: 'tall',
    styleVars: {
      '--tech-card-padding': '42px 48px 12px',
      '--tech-card-align-items': 'center',
      '--tech-card-title-width': '276px',
      '--tech-card-title-height': '63px',
      '--tech-card-title-min-height': '63px',
      '--tech-card-text-width': '290px',
      '--tech-card-text-margin': '14px 0 0',
      ...
      '--tech-card-mobile-title-width': '187px',
      '--tech-card-mobile-text-top': '77px',
      '--tech-card-mobile-text-width': '137px',
      '--tech-card-mobile-art-top': '194px',
      '--tech-card-mobile-art-width': '113px',
      '--tech-card-mobile-art-height': '74px'
    },
    mobileShell: { width: '201px', height: '300px', top: '0px', left: '0px', background: '#D9D9D9', borderRadius: '22px' },
    art: { type: 'image', src: '/image/tech-hogar-gps.webp', width: 207, height: 122 }
  }
];
